...
// VALORES VINDO DO FORMULÁRIO e VALIDAÇÃO
    //  res.send(req.body) informados vlr digitados no formulários, q vieram do body-parser (pega as informações)
    //  console.log(req.body) imprime os valores no console, dos valores digitados no formulário
    //  res.send(req.body.email) envia o email digitado para o browser o email

   var nome = req.body.nome;
   var email = req.body.email;

   //ARRAY QUE VAI CONTER TODOS OS ERROS 
   const erros = [];
